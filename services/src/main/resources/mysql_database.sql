...
INSERT INTO user (username, password, first_name, last_name, email, role) VALUES
  ('mysql_serhiilytka', '$2a$04$8km1JN9lPh4C3jn.lsAZiuIq.8xK4QZAWrzSZpZo6TpV7c4gi5Fyu', 'Serhii', 'Lytka', 'serhii@gmail.com', 'ADMIN'),
  ('mysql_marypublic', '$2a$04$8km1JN9lPh4C3jn.lsAZiuIq.8xK4QZAWrzSZpZo6TpV7c4gi5Fyu', 'Mary', 'Public', 'mary@gmail.com', 'CASHIER'),
  ('mysql_johndou', '$2a$04$8km1JN9lPh4C3jn.lsAZiuIq.8xK4QZAWrzSZpZo6TpV7c4gi5Fyu', 'John', 'Dou', 'john@gmail.com', 'USER');


INSERT INTO ticket (title, description, created_at) VALUES
  ('mysql_title1', 'description for title1', '2019-09-11 12:00:00'),
  ('mysql_title2', 'description for title2', '2019-09-11 12:30:00'),
  ('mysql_title3', 'description for title3', '2019-09-11 13:00:00'),
  ('mysql_title4', 'description for title4', '2019-09-11 13:30:00');
